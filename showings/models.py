...
class Show(models.Model):
    series = models.ForeignKey('showings.Series', null=False, on_delete=models.PROTECT)
    details = models.CharField(max_length=200, help_text='Episodes watched (Ep.1, Eps. 1-3), ect.')
    shown_at = models.ForeignKey('showings.Showing', null=False, blank=False, on_delete=models.CASCADE)
